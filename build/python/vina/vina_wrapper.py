...
class Vina(object):
    ...
    def set_ligand(self, *args) -> "void":
        return _vina_wrapper.Vina_set_ligand(self, *args)
    ...
    def compute_vina_maps(self, center_x: "double", center_y: "double", center_z: "double", size_x: "double", size_y: "double", size_z: "double", granularity: "double"=0.375) -> "void":
        return _vina_wrapper.Vina_compute_vina_maps(self, center_x, center_y, center_z, size_x, size_y, size_z, granularity)
    ...
    def global_search(self, n_poses: "int const"=20, min_rmsd: "double const"=1.0) -> "void":
        return _vina_wrapper.Vina_global_search(self, n_poses, min_rmsd)

    def write_results(self, output_name: "std::string const &", how_many: "int"=9, energy_range: "double"=3.0) -> "void":
        return _vina_wrapper.Vina_write_results(self, output_name, how_many, energy_range)
    ...
    def test(self) -> "int":
        ...
        return _vina_wrapper.Vina_test(self)
